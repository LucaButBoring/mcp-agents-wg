...
1. **Join the community** — Connect on the `#agents-wg` channel in [MCP Discord](https://discord.com/invite/6CSzBmMkjX)
2. **Understand the scope** — Review the [README](./README.md)
...
All participants must follow the [MCP Code of Conduct](https://github.com/modelcontextprotocol/.github/blob/main/CODE_OF_CONDUCT.md).
